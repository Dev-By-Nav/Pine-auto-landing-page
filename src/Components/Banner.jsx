  ...
  return (
    <div className='h-[50vw] flex'>
      ...
      <div className='relative flex flex-col items-center w-full pt-[5vw]'>
        <h1 className='text-white text-[40px] md:text-[55px] lg:text-[70px] font-bold'>Luxury Made Easy</h1>
        <p className='text-center text-[15px] md:text-[20px] lg:text-[25px] text-white font-semibold'>If your looking for a luxury chauffeuer or a self-drive.<br/>We've got you covered.</p>
