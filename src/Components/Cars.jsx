...
const Cars = () => {
  return (
    <div className='grid grid-cols-4 lg:grid-cols-8 gap-4  '>
        <img src={Audi} alt="" className='px-5' />
        <img src={Bentley} alt="" className='px-2 mt-2' />
        <img src={BMW} alt="" className='px-7'/>
        <img src={Jaguar} alt="" className='px-6'/>
        <img src={Lamborghini} alt="" className='px-7'/>
        <img src={Mercedes} alt="" className='px-6'/>
        <img src={Porsche} alt="" className='px-7'/>
        <img src={RollsRoyce} alt="" className='px-6'/>
    </div>
  )
}
